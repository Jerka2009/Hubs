...
if game.PlaceId ~= 6839171747 or game.ReplicatedStorage.GameData.Floor.Value ~= "Rooms" then
	game.StarterGui:SetCore("SendNotification", { Title = "Неверное место"; Text = "Обнаруженная игра, по-видимому, не является rooms. Пожалуйста, выполняйте это, находясь в rooms!" })
...
elseif workspace:FindFirstChild("PathFindPartsFolder") then
	game.StarterGui:SetCore("SendNotification", { Title = "Предупреждение"; Text = "Если у вас возникли проблемы и бот не работает, пожалуйста, свяжитесь со мной! geodude#2619" })
...
if LocalPlayer.PlayerGui.MainUI.Initiator.Main_Game.RemoteListener.Modules:FindFirstChild("A90") then
    LocalPlayer.PlayerGui.MainUI.Initiator.Main_Game.RemoteListener.Modules.A90.Name = "Genus" -- Fuck you A90
end
...
LatestRoom:GetPropertyChangedSignal("Value"):Connect(function()
    ...
    if LatestRoom.Value ~= 1000 then
        ...
        game.StarterGui:SetCore("SendNotification", { Title = "Rescripted by Jerka2009"; Text = "Спасибо, что воспользовались моим скриптом!" })
        return
    end
end)
